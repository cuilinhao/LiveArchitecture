...
@interface _MSPUIControlBlockTarget : NSObject
...
@implementation _MSPUIControlBlockTarget
...
@implementation UIControl (MSPAdd)
...
- (void)addBlockForControlEvents:(UIControlEvents)controlEvents
    ...
    _MSPUIControlBlockTarget *target = [[_MSPUIControlBlockTarget alloc]
...
- (void)removeAllBlocksForControlEvents:(UIControlEvents)controlEvents {
    ...
    [targets enumerateObjectsUsingBlock: ^(id obj, NSUInteger idx, BOOL *stop) {
        _MSPUIControlBlockTarget *target = (_MSPUIControlBlockTarget *)obj;
