...
NSString *const kMSPGPUImageBeautyFragmentShaderString = SHADER_STRING(
...
@implementation MSPGPUImageBeautyFilter

 - (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kMSPGPUImageBeautyFragmentShaderString])) {
        return nil;
    }
