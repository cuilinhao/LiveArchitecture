...
#import "MSPGPUImageBeautyFilter.h"
...
@interface MSPVideoCapture ()

@property (nonatomic, strong) GPUImageVideoCamera *videoCamera;
@property (nonatomic, strong) MSPGPUImageBeautyFilter *beautyFilter;
...
@implementation MSPVideoCapture
...
- (instancetype)initWithVideoConfiguration:(MSPVideoConfiguration *)configuration {
    if (self = [super init])
    {
...
- (void)reloadFilter
{
    ...
    if (self.beautyFace)
    {
        self.output = [[MSPGPUImageEmptyFilter alloc] init];
        self.filter = [[MSPGPUImageBeautyFilter alloc] init];
        self.beautyFilter = (MSPGPUImageBeautyFilter*)self.filter;
    }
    else
    {
        self.output = [[MSPGPUImageEmptyFilter alloc] init];
        self.filter = [[MSPGPUImageEmptyFilter alloc] init];
